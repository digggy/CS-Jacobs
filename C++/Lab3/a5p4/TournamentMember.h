...
class Player : public TournamentMember{
    ...
    public:
        Player(const char fname[31],const char lname[31],const char dob[11],
        int age,std::string nationality,int number,
...
class Referee : public TournamentMember{
    ...
    public:
        Referee(const char fname[31],const char lname[31],const char dob[11],
